...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxComposeUiLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public AndroidxComposeUiLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for ui (androidx.compose.ui:ui-util)
             * This dependency was declared in catalog libs.versions.toml
         * @deprecated Will be removed in Gradle 9.0.
             */
        @Deprecated
    ...
    public static class KtorVersionAccessors extends VersionFactory  {
        ...
        /**
         * Returns the group of versions at versions.ktor.serialization
         */
    ...
    public static class KtorClientVersionAccessors extends VersionFactory  {
        ...
        public KtorClientVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: ktor.client.android (2.3.5)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getAndroid() { return getVersion("ktor.client.android"); }

            /**
             * Returns the version associated to this alias: ktor.client.core (2.3.6)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class KtorSerializationVersionAccessors extends VersionFactory  {
        ...
        /**
         * Returns the group of versions at versions.ktor.serialization.kotlinx
         */
    ...
    public static class KtorSerializationKotlinxVersionAccessors extends VersionFactory  {
        ...
        public KtorSerializationKotlinxVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: ktor.serialization.kotlinx.json (2.3.5)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        private final GitlabPluginAccessors paccForGitlabPluginAccessors = new GitlabPluginAccessors(providers, config);
        ...
        /**
         * Returns the group of plugins at plugins.gitlab
         */
        public GitlabPluginAccessors getGitlab() {
            return paccForGitlabPluginAccessors;
        }
    ...
    public static class GitlabPluginAccessors extends PluginFactory {

        public GitlabPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Creates a plugin provider for gitlab.detekt to the plugin id 'io.gitlab.arturbosch.detekt'
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getDetekt() { return createPlugin("gitlab.detekt"); }
    ...
    public static class JetbrainsPluginAccessors extends PluginFactory {
        ...
        public JetbrainsPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Creates a plugin provider for jetbrains.serialization to the plugin id 'org.jetbrains.kotlin.plugin.serialization'
             * This plugin was declared in catalog libs.versions.toml
             */
